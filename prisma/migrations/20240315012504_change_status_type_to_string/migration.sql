/*
  ...
  - You are about to alter the column `status` on the `pedagangs` table. The data in that column could be lost. The data in that column will be cast from `TinyInt` to `VarChar(100)`.
...
-- AlterTable
ALTER TABLE `pedagangs` MODIFY `status` VARCHAR(100) NULL;
