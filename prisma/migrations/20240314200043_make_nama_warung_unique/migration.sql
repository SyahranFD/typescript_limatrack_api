/*
  ...
  - A unique constraint covering the columns `[nama_warung]` on the table `pedagangs` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `pedagangs_nama_warung_key` ON `pedagangs`(`nama_warung`);
